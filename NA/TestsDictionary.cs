...
namespace ations
{
  public partial class Tests
  {
    ...
    string startWithTest = "red_fort"; // autotests start with america_dyn1
    public bool stopAfterTest = false;
    ...
    Dictionary<string, Action> TestDictionary = new Dictionary<string, Action>()
    {
      ...
      {"entente_cordiale", ()=> { TestEventResolution(
        ...
        new List<Action> { ClickOk },
        ()=>{ GameInst.Checker.CalcStabAndMil(P1); return RD1("coal") == -6 && P1.Military == 12; }); }
      },
      ...
      {"red_fort", ()=> { TestAction(
        ...
        ()=> { P0_WOND1("red_fort"); ProgressCosting("hoplite",1);},
        new List<Action> {ClickProgressCosting1, ClickBM3, ClickOk, ClickPass},
