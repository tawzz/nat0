...
namespace ations
{
  public static class CT
  {
    ...
    public static bool adv(this ACard c) { return c.Type == "advisor"; }
    public static bool build(this string s) { return s == "building"; }
    public static bool build(this ACard c) { return c.Type == "building"; }
    public static bool mil(this string s) { return s == "military"; }
    public static bool mil(this ACard c) { return c.Type == "military"; }
    public static bool buildmil(this string s) { return s == "advisor"; }
    public static bool buildmil(this ACard c) { return c.Type == "advisor"; }
    public static bool wonder(this string s) { return s == "wonder"; }
    public static bool wonder(this ACard c) { return c.Type == "wonder"; }
    public static bool colony(this string s) { return s == "colony"; }
    public static bool colony(this ACard c) { return c.Type == "colony"; }
    public static bool war(this string s) { return s == "war"; }
    public static bool war(this ACard c) { return c.Type == "war"; }
    public static bool battle(this string s) { return s == "battle"; }
    public static bool battle(this ACard c) { return c.Type == "battle"; }
    public static bool golden(this string s) { return s == "golden"; }
    public static bool golden(this ACard c) { return c.Type == "golden"; }
    public static bool dyn(this string s) { return s == "dynasty"; }
    public static bool dyn(this ACard c) { return c.Type == "dynasty"; }
    public static bool civ(this string s) { return !(s.war() || s.golden() || s.battle()); }
    public static bool civ(this ACard c) { return !(c.war() ||c.golden()||c.battle()); }
