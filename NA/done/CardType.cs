...
namespace ations
{
  public static class CardType
  {
    ...
    public static Dictionary<string, Brush> typeColors = new Dictionary<string, Brush>() {
      ...
      {"dynasty", new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FF003366"))},//Brushes.Navy },//new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FF7A6565"))},
      {"wonder", new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FF703F10"))},
      {"natural", new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FF703F10"))},
    ...
    public const int iADV = 0;
    public const int iWIC = 6;
    public const int iDYN = 5;
  }
}
